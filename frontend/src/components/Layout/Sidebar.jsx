    ...
    <>
      ...
      <nav>
        <ul className="space-y-6">
            ...
            <NavLinkButton to="/scans" type="desktop" label="Scans" icon={<Icon path={mdiQrcodeScan} size={0.85} className="ms-5"/>}/>
            <NavLinkButton to="/roles" type="desktop" label="Roles" icon={<Icon path={mdiShieldAccount} size={0.85} className="ms-5"/>}/>
        </ul>
      </nav>
    </>
  );
