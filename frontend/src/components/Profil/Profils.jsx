...
export default function Profils() {
    ...
    // GET /me pour récupérer les infos de l'utilisateur connecté
    useEffect(() => {
        axios.get("/api/me")
    ...
    // Mise à jour du profil (PUT /profile)
    ...
    // Mise à jour du mot de passe (PUT /password)
    ...
    // Désactivation du compte (DELETE /me)
    const handleDelete = () => {
        axios.delete("/api/me")
        .then(() => {
